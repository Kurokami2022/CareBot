      ...
      <IonContent fullscreen>
        <IonList className="base">
          ...
          <IonModal isOpen={isPurposeOpen} className="modal1">
            <IonButtons slot="end">
              <IonButton onClick={() => setIsPurposeOpen(false)}>
                Close
              </IonButton>
            </IonButtons>
            <IonContent>
              <p className="purpcontent">
                <IonLabel className="purp">PURPOSE</IonLabel>
                <br />
          ...
          <IonModal isOpen={isFeaturesOpen} className="modal2">
            <IonButtons slot="end">
              <IonButton onClick={() => setIsFeaturesOpen(false)}>
                Close
              </IonButton>
            </IonButtons>
            <IonContent>
              <p className="featcontent">
                <IonLabel className="purp">KEY FEATURES</IonLabel>
                <br />
                <p className="functions">
                  <IonLabel>
                    Manage daily schedule and to-do lists, setting reminders and
                    notifications for upcoming events and tasks.
                  </IonLabel>
                </p>
                <p className="functions">
                  <IonLabel>
                    Using AI to analyze a user's spending habits and provide
                    personalized financial advice and budgeting suggestions.
                  </IonLabel>
                </p>
                <p className="functions">
                  <IonLabel>
                    Personalized health and fitness recommendations based on
                    physical activity, diet, and sleep patterns, as well as
                    tracking their progress and offering motivational tips.
                  </IonLabel>
                </p>
              </p>
            </IonContent>
          ...
          <IonList className="taBase"></IonList>
        </IonList>
      </IonContent>
    </IonPage>
  );
